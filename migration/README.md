...
Phases still to come: 4a and 4b (store module, Firestore, state to `useState`), 5 (Firebase Auth and Security Rules), 6 (finish stripping, docs), 7 (final verification).
